...
The Flipper app reads a compact snapshot file from `/ext/apps_data/ai_dashboard/usage.txt`.

The companion bridge script can:

- collect Codex usage through `codex app-server`
- parse Claude usage through `claude /usage`
